    ...
    execute: (args) => {
        ...
        switch(args[1].toLowerCase())
        {
            ...
            case "insert":
                ...
                waypoints.splice(wNum-1, 0, {x: wX, y: wY, z: wZ, r:0, g:1, b: 0, options: {name: wNum}})
    ...
    for(let i = 0; i < waypoints.length; i++)
    {
        ...
        if(draw)
            drawCoolWaypoint(waypoints[i].x, waypoints[i].y,
                waypoints[i].z, r, g, b, { name: i+1, renderBeacon: false, alpha, drawBox: false, showDist: settings.waypointShowDistance})
    }
})
