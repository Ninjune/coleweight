...
addEvent("efficientMinerOverlay", register("renderWorld", () => {
    ...
    try{
        trace(drawBlocks[0].x, drawBlocks[0].y + 5/10, drawBlocks[0].z, 1, 0, 0.3, 0.7)
...
function findPrio(originX, originY, originZ, blockStateToFind, prio){
    let radius = 2 + 1/2
    let blockCount = 0
    let rayTraceX, rayTraceY, rayTraceZ
