...
const WIDTH = 3.5 // not actually width more like reverse of width lmao, bigger = smaller
const HEIGHT = 2.877 // ^

let ScreenW = Renderer.screen.getWidth()
let ScreenH = Renderer.screen.getHeight()

const coordsWindow = (row, column, title, command, desc, image=false, alternateText="") =>{
