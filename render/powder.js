...
export function powderCalc(args)
{
    ...
    switch(args[0])
    {
        case undefined:
            ...
            new TextComponent(`${constants.PREFIX}&bHover over the Heart of the Mountain icon, hold whatever drill you plan to use, and hover over your profile in /sbmenu. &7[&eNEXT&7]`)
        ...
        case "m7":
            ...
            break
        case "d1":
            ChatLib.chat(`${constants.PREFIX}idk bro just get all fortune.`)
            break
    }
    ...
    if(run)
    {
        ...
        ChatLib.chat(`${constants.PREFIX}&bCalculating...`)
